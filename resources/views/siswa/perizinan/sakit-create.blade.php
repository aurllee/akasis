                ...
                <form action="{{ route('siswa.perizinan.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <select name="jenis" id="jenis" class="form-select @error('jenis') is-invalid @enderror">
                            ...
                            <option value="pulang" {{ old('jenis') === 'pulang' ? 'selected' : '' }}>
                                Izin Pulang
                            </option>
                    ...
                    <div id="infoIzin" class="info-box mb-4 d-none">

                        <strong>Izin</strong>

                        <div class="text-muted small mt-1">
                            Digunakan untuk pengajuan izin selain sakit. Pengajuan akan
                            diverifikasi oleh wali kelas.
                        </div>
                    ...
                    <div class="mb-3 d-none" id="fieldJamMulai">
                    ...
                    <div class="mb-3 d-none" id="fieldJamSelesai">
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <a href="{{ route('siswa.perizinan.index') }}" class="btn btn-secondary">
                            Kembali
                        </a>
