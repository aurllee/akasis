                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <select name="jk" class="form-select" required>
                                @foreach(['Laki-laki', 'Perempuan'] as $jk)
                                    <option value="{{ $jk }}" @selected(old('jk', $guru->jk) === $jk)>
                                        {{ $jk }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="tgl_lahir" class="form-control"
                                value="{{ old('tgl_lahir', optional($guru->tgl_lahir)->format('Y-m-d')) }}"
                                required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="agama" class="form-select" required>
                                @foreach(['Islam', 'Kristen', 'Katolik', 'Hindu', 'Budha', 'Konghucu'] as $agama)
                                    <option value="{{ $agama }}" @selected(old('agama', $guru->agama) === $agama)>
                                        {{ $agama }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="tmt" class="form-control"
                                value="{{ old('tmt', optional($guru->tmt)->format('Y-m-d')) }}" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="status_kepegawaian" class="form-select" required>
                                @foreach(['PNS', 'PPPK', 'Honorer', 'Guru_tetap', 'Guru_tidak_tetap'] as $status)
                                    <option value="{{ $status }}" @selected(old('status_kepegawaian', $guru->status_kepegawaian) === $status)>
                        ...
                        <div class="form-group">
                            ...
                            <select name="jabatan" class="form-select" required>
                                @foreach(['Guru', 'Kepala_sekolah', 'Waka_sekolah'] as $jabatan)
                                    <option value="{{ $jabatan }}" @selected(old('jabatan', $guru->jabatan) === $jabatan)>
                        ...
                        <div class="form-group full">
                            ...
                            <select name="mata_pelajaran_id" class="form-select" required>
                                @foreach($mataPelajaran as $mapel)
                                    <option value="{{ $mapel->id }}" @selected(old('mata_pelajaran_id', $guru->mata_pelajaran_id) == $mapel->id)>
                                        {{ $mapel->nama_mapel }}
                                    </option>
                                @endforeach
                            </select>
