    ...
    <div class="page-wrap">
        <div class="page-card">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <a href="{{ route('guru.penilaian.index') }}" class="btn btn-secondary fs-12">
                    Kembali
                </a>
            </div>
            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <a href="{{ route('guru.penilaian.create', $jadwal->id) }}" class="btn btn-primary fs-12">
                    + Tambah Penilaian
                </a>
            </div>
                                ...
                                @forelse($siswa as $index => $item)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ route('guru.penilaian.editSiswa', ['jadwal' => $jadwal->id, 'siswa' => $item->id]) }}"
